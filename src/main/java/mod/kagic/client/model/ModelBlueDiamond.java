...
public class ModelBlueDiamond extends ModelBiped {
	private ModelRenderer bipedNeck;
	private ModelRenderer bipedSkirt;
	
	public ModelBlueDiamond() {
		...
		this.bipedHeadwear.addBox(-5F, -50F, -5F, 10, 18, 10, 1.1F);
		...
		this.bipedSkirt.addBox(-7F, 0F, -3F, 14, 28, 6);
		this.bipedSkirt.setRotationPoint(0F, -9F, 0F);
		// Right arm.
		this.bipedRightArm = new ModelRenderer(this, 64, 28);
		this.bipedRightArm.addBox(-4F, 0F, -2F, 4, 32, 4);
		this.bipedRightArm.setRotationPoint(0F, -32F, 0F);
		// Left arm.
		this.bipedLeftArm = new ModelRenderer(this, 64, 64);
		this.bipedLeftArm.addBox(0F, 0F, -2F, 4, 32, 4);
		...
		this.bipedRightLeg.setRotationPoint(0F, 32F, 0F);
		// Left leg.
		this.bipedLeftLeg = new ModelRenderer(this, 0, 22);
		this.bipedLeftLeg.addBox(0F, 0F, -3F, 6, 32, 6);
		this.bipedLeftLeg.setRotationPoint(0F, 32F, 0F);
	}
