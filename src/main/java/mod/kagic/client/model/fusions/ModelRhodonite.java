...
public class ModelRhodonite extends ModelGem {
	...
	public ModelRhodonite(float modelSize, boolean isArmor) {
		...
		this.setRotateAngle(this.bipedLeftArm, 0.0F, 0.0F, -0.2617993877991494F);
		...
		this.setRotateAngle(this.bipedRightArm, 0.0F, 0.0F, 0.2617993877991494F);
		...
		this.setRotateAngle(this.lower_arm_left, -1.0471975511965976F, 0.0F, -1.3962634015954636F);
		...
		this.setRotateAngle(this.lower_arm_right, -1.0471975511965976F, 0.0F, 1.3962634015954636F);
