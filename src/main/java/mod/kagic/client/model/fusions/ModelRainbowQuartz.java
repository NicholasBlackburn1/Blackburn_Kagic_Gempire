...
public class ModelRainbowQuartz extends ModelGem {
	...
	public ModelRainbowQuartz(float modelSize) {
		...
		this.setRotateAngle(this.nose, 1.2292353921796064F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedLeftArm, 0.0F, 0.0F, -0.08726646259971647F);
		...
		this.setRotateAngle(this.bipedRightArm, 0.0F, 0.0F, 0.08726646259971647F);
