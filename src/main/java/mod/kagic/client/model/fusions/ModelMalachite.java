package mod.kagic.client.model.fusions;
...
public class ModelMalachite extends ModelGem {
	...
	public ModelMalachite(float modelSize) {
		...
		this.setRotateAngle(this.hair, 0.7853981633974483F, -1.0927506446736497F, 1.5707963267948966F);
		...
		this.setRotateAngle(this.bipedLeftArm, 0.0F, 0.0F, -0.5235987755982988F);
		...
		this.setRotateAngle(this.bipedRightArm, 0.0F, 0.0F, 0.5235987755982988F);
		...
		this.setRotateAngle(this.abdomen, -0.136659280431156F, 0.0F, 0.0F);
		
		this.leg = new ModelRenderer(this, 100, 0);
		this.leg.setRotationPoint(2.4F, 4.8F, 2.6F);
		this.leg.addBox(-2.5F, 0.0F, -2.5F, 5, 13, 5, 0.0F);
		this.setRotateAngle(this.leg, -0.2617993877991494F, 0.0F, -0.5235987755982988F);
		...
		this.setRotateAngle(this.leg_1, -0.2617993877991494F, 0.0F, 0.5235987755982988F);
		...
		this.setRotateAngle(this.leg_2, 0.5235987755982988F, 0.0F, -0.5235987755982988F);
		...
		this.setRotateAngle(this.leg_3, 0.5235987755982988F, 0.0F, 0.5235987755982988F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		if (this.swingProgress > 0.0F) {
			...
			mainHandModel.rotateAngleX = (float) (mainHandModel.rotateAngleX - (f2 * 1.2D + f3));
		...
		// copyModelAngles(this.bipedHead,
		// this.bipedHeadwear);
