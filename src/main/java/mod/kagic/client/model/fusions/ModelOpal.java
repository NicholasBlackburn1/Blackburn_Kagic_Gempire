...
public class ModelOpal extends ModelGem {
	...
	public ModelOpal(float modelSize) {
		...
		this.setRotateAngle(this.Hair, 0.18203784098300857F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.lower_arm_left, 0.0F, 0.0F, -0.3490658503988659F);
		...
		this.setRotateAngle(this.lower_arm_right, 0.0F, 0.0F, 0.3490658503988659F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		// super.setRotationAngles(limbSwing,
		...
		if (this.swingProgress > 0.0F) {
			...
			mainArm.rotateAngleX = (float) (mainArm.rotateAngleX - (f2 * 1.2D + f3));
