...
public class ModelCorruptedWatermelonTourmaline extends ModelGem {
	...
	public ModelCorruptedWatermelonTourmaline() {
		...
		this.bipedHead.addChild(this.spike1);
		this.bipedHead.addChild(this.spike2);
		this.bipedHead.addChild(this.spike3);
		this.bipedHead.addChild(this.spike4);
		this.bipedHead.addChild(this.spike5);
	}
