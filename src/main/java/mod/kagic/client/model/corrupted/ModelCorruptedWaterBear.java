package mod.kagic.client.model.corrupted;
...
public class ModelCorruptedWaterBear extends ModelGem {
	...
	public ModelCorruptedWaterBear() {
		...
		this.setRotateAngle(this.leg_in1r, 0.0F, 0.0F, 0.7853981633974483F);
		...
		this.setRotateAngle(this.head_inside, 0.27314402793711257F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.head_outside, 0.27314402793711257F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.tail_inside, -0.136659280431156F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.leg_in1l, 0.0F, 0.0F, -0.7853981633974483F);
		...
		this.setRotateAngle(this.leg_in3r, -0.5235987755982988F, 0.0F, 0.5235987755982988F);
		...
		this.setRotateAngle(this.tail_outside, -0.136659280431156F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.leg_in3l, -0.5235987755982988F, 0.0F, -0.5235987755982988F);
		...
		this.setRotateAngle(this.leg_in2l, 0.5235987755982988F, 0.0F, -0.7853981633974483F);
		...
		this.setRotateAngle(this.leg_in2r, 0.5235987755982988F, 0.0F, 0.7853981633974483F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		// this.spiderHead.rotateAngleY = netHeadYaw *
		// 0.017453292F;
		// this.spiderHead.rotateAngleX = headPitch *
		// 0.017453292F;
		...
		// this.spiderLeg7.rotateAngleZ = -((float)Math.PI /
		// 4F);
		// this.spiderLeg8.rotateAngleZ = ((float)Math.PI /
		// 4F);
		float f1 = -0.0F;
		float f2 = 0.3926991F;
		...
		// this.spiderLeg7.rotateAngleY = -((float)Math.PI /
		// 4F);
		// this.spiderLeg8.rotateAngleY = ((float)Math.PI /
		// 4F);
