...
public class ModelCorruptedQuartz extends ModelQuadruped {
	...
	public ModelCorruptedQuartz() {
		...
		this.setRotateAngle(this.head_extra, 0.136659280431156F, 0.0F, 0.0F);
		
		this.body = new ModelRenderer(this, 0, 0);
		this.body.setRotationPoint(0.0F, 5.5F, 0.0F);
		this.body.addBox(-6.0F, -6.0F, -7.5F, 12, 14, 15, 0.0F);
		this.setRotateAngle(this.body, -0.12217304763960307F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.body2, 0.0F, 0.017453292519943295F, 0.0F);
		...
		this.setRotateAngle(this.tail, 0.4553564018453205F, 0.017453292519943295F, 0.0F);
		...
		this.setRotateAngle(this.leg3, -0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.leg4, -0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.back_leg_bottom_1, -0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.back_leg_bottom, -0.7853981633974483F, 0.0F, 0.0F);
