...
public class ModelTongueMonster extends ModelGem {
	...
	public ModelTongueMonster() {
		...
		this.setRotateAngle(this.bipedBody, 0.12217304763960307F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bipedLeftLeg, 0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.leg_2_left, -1.0471975511965976F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.foot_left, 0.22759093446006054F, -0.005235987755982988F, 0.0F);
		...
		this.setRotateAngle(this.bipedRightLeg, 0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.leg_2_right, -1.0471975511965976F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.foot_right, 0.22759093446006054F, 0.0F, 0.0F);
