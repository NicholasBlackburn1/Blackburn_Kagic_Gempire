...
public class LayerHair extends GemLayer implements LayerRenderer<EntityGem> {
	...
	public void doRenderLayer(EntityGem gem, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		float r = ((hairColor & 16711680) >> 16) / 255f;
		float g = ((hairColor & 65280) >> 8) / 255f;
		float b = ((hairColor & 255) >> 0) / 255f;
		GlStateManager.color(r + this.offset, g + this.offset, b + this.offset/*
																				 * ,
																				 * 0
																				 * .
																				 * 99f
