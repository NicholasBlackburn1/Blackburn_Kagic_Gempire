...
import mod.kagic.client.render.RenderTopaz;
...
public class LayerTopazItem implements LayerRenderer<EntityLivingBase> {
	protected final RenderTopaz livingEntityRenderer;
