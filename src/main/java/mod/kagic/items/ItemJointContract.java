...
public class ItemJointContract extends Item {
	public ItemJointContract() {
		super();
		this.setUnlocalizedName("joint_contract");
	...
	public void onCreated(ItemStack stack, World worldIn, EntityPlayer playerIn) {
		...
		stack.setStackDisplayName(new TextComponentTranslation("item.joint_contract.signedname", playerIn.getName()).getUnformattedComponentText());
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (this.getOwner(playerIn.getHeldItem(hand)) == null) {
			...
			playerIn.getHeldItem(hand).setStackDisplayName(new TextComponentTranslation("item.joint_contract.signedname", playerIn.getName()).getUnformattedComponentText());
		}
