...
public class ItemPeaceTreaty extends Item {
	public ItemPeaceTreaty() {
		super();
		this.setUnlocalizedName("peace_treaty");
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (this.getOwner(playerIn.getHeldItem(hand)) == null) {
			...
			playerIn.getHeldItem(hand).setStackDisplayName(new TextComponentTranslation("item.peace_treaty.signedname", playerIn.getName()).getUnformattedComponentText());
		}
