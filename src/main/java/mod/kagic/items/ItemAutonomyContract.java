...
public class ItemAutonomyContract extends Item {
	public ItemAutonomyContract() {
		super();
		this.setUnlocalizedName("autonomy_contract");
	...
	public void onCreated(ItemStack stack, World worldIn, EntityPlayer playerIn) {
        ...
        stack.setStackDisplayName(new TextComponentTranslation("item.autonomy_contract.signedname", playerIn.getName()).getUnformattedComponentText());
    }
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (this.getOwner(playerIn.getHeldItem(hand)) == null) {
			...
			playerIn.getHeldItem(hand).setStackDisplayName(new TextComponentTranslation("item.autonomy_contract.signedname", playerIn.getName()).getUnformattedComponentText());
		}
