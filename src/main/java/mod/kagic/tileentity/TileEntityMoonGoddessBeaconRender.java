...
public class TileEntityMoonGoddessBeaconRender extends TileEntitySpecialRenderer<TileEntityMoonGoddessStatue> {
	...
	public void render(TileEntityMoonGoddessStatue statue, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		this.bindTexture(TileEntityMoonGoddessBeaconRender.TEXTURE_BEACON_BEAM);
		...
		if (beamRenderScale > 0.0D) {
			...
			TileEntityMoonGoddessBeaconRender.renderBeam(x, y, z, partialTicks, beamRenderScale, statue.getWorld().getTotalWorldTime(), 512, TileEntityMoonGoddessBeaconRender.COLORS, 0.375D, 0.4D);
	...
	public static void renderBeam(double x, double y, double z, double partialTicks, double textureScale, double totalWorldTime, int height, float[] colors, double beamRadius, double glowRadius) {
		...
		bufferbuilder.pos(x + d4, y + height, z + d5).tex(1.0D, d15).color(red, green, blue, midTransparency).endVertex();
		...
		bufferbuilder.pos(x + d6, y + height, z + d7).tex(0.0D, d15).color(red, green, blue, midTransparency).endVertex();
		bufferbuilder.pos(x + d10, y + height, z + d11).tex(1.0D, d15).color(red, green, blue, midTransparency).endVertex();
		...
		bufferbuilder.pos(x + d8, y + height, z + d9).tex(0.0D, d15).color(red, green, blue, midTransparency).endVertex();
		bufferbuilder.pos(x + d6, y + height, z + d7).tex(1.0D, d15).color(red, green, blue, midTransparency).endVertex();
		...
		bufferbuilder.pos(x + d10, y + height, z + d11).tex(0.0D, d15).color(red, green, blue, midTransparency).endVertex();
		bufferbuilder.pos(x + d8, y + height, z + d9).tex(1.0D, d15).color(red, green, blue, midTransparency).endVertex();
		...
		bufferbuilder.pos(x + d4, y + height, z + d5).tex(0.0D, d15).color(red, green, blue, midTransparency).endVertex();
		tessellator.draw();
		d3 = 0.5D - glowRadius;
		d4 = 0.5D - glowRadius;
		d5 = 0.5D + glowRadius;
		...
		bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		bufferbuilder.pos(x + d3, y + height, z + d4).tex(1.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		...
		bufferbuilder.pos(x + d5, y + height, z + d6).tex(0.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		bufferbuilder.pos(x + d9, y + height, z + d10).tex(1.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		...
		bufferbuilder.pos(x + d7, y + height, z + d8).tex(0.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		bufferbuilder.pos(x + d5, y + height, z + d6).tex(1.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		...
		bufferbuilder.pos(x + d9, y + height, z + d10).tex(0.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		bufferbuilder.pos(x + d7, y + height, z + d8).tex(1.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		...
		bufferbuilder.pos(x + d3, y + height, z + d4).tex(0.0D, d14).color(red, green, blue, outerTransparency).endVertex();
		tessellator.draw();
