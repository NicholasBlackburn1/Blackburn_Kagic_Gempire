...
public class TileEntityHeavenlyBeetleHouse extends TileEntity implements ITickable {
	
	private double effectiveDistance = 40D;
	private Potion potionEffect = Potion.getPotionFromResourceLocation("regeneration");
	...
	private void addPotionEffects() {
		...
		int y = this.pos.getY();
		int z = this.pos.getZ();
		AxisAlignedBB axisalignedbb = new AxisAlignedBB(x, y, z, x + 1, y + 1, z + 1).grow(this.effectiveDistance, this.world.getHeight(), this.effectiveDistance);
