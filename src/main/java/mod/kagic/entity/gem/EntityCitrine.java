...
public class EntityCitrine extends EntityQuartzSoldier implements IAnimals {
	...
	public EntityCitrine(World worldIn) {
		...
		this.dataManager.register(EntityCitrine.CHARGED, false);
		this.dataManager.register(EntityCitrine.DEFECTIVE_COLOR, 0);
	}
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
		...
		this.dataManager.set(EntityCitrine.DEFECTIVE_COLOR, this.generateDefectiveColor());
		return super.onInitialSpawn(difficulty, livingdata);
	}

	@Override
	public void writeEntityToNBT(NBTTagCompound compound) {
		compound.setBoolean("charged", this.dataManager.get(EntityCitrine.CHARGED).booleanValue());
		compound.setInteger("charge_ticks", this.charge_ticks);
		compound.setInteger("hit_count", this.hit_count);
		compound.setInteger("defectiveColors", this.dataManager.get(EntityCitrine.DEFECTIVE_COLOR));
		super.writeEntityToNBT(compound);
	}
	@Override
	public void readEntityFromNBT(NBTTagCompound compound) {
		this.dataManager.set(EntityCitrine.CHARGED, compound.getBoolean("charged"));
		this.charge_ticks = compound.getInteger("charge_ticks");
		this.hit_count = compound.getInteger("hit_count");
		this.dataManager.set(EntityCitrine.DEFECTIVE_COLOR, compound.getInteger("defectiveColors"));
	...
	public boolean isCharged() {
		return this.dataManager.get(EntityCitrine.CHARGED);
	}
	
	public void setCharged(boolean charged) {
		this.dataManager.set(EntityCitrine.CHARGED, charged);
	}
	...
	public int getDefectiveColor() {
		return this.dataManager.get(EntityCitrine.DEFECTIVE_COLOR);
	}
