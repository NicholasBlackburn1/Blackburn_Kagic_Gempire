...
public class EntitySameTypeFusion extends EntityFusionGem {
	...
	public boolean addGem(EntityGem gem) {
		...
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).getBaseValue() + gem.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).getBaseValue());
