...
public class EntityPearl extends EntityGem implements IInventoryChangedListener, INpc {
	...
	public EntityPearl(World worldIn) {
		...
		this.dataManager.register(EntityPearl.COLOR, this.rand.nextInt(16));
		this.dataManager.register(EntityPearl.HAIR_COLOR, this.dataManager.get(EntityPearl.COLOR));
		this.dataManager.register(EntityPearl.VISOR_COLOR, this.dataManager.get(EntityPearl.COLOR));
		this.dataManager.register(EntityPearl.DRESS_STYLE, 1);
		this.dataManager.register(EntityPearl.NAKED, false);
	}
	...
	public void setColor(int color) {
		this.dataManager.set(EntityPearl.COLOR, color);
		this.setGemColor(this.generateGemColor());
	}
	public int getColor() {
		return this.dataManager.get(EntityPearl.COLOR);
	}
	public void setVisorColor(int color) {
		this.dataManager.set(EntityPearl.VISOR_COLOR, color);
	}
	public int getVisorColor() {
		return this.dataManager.get(EntityPearl.VISOR_COLOR);
	}

	@Override
	public void setHairColor(int color) {
		this.dataManager.set(EntityPearl.HAIR_COLOR, color);
	}

	@Override
	public int getHairColor() {
		return this.dataManager.get(EntityPearl.HAIR_COLOR);
	}
	public void setDressStyle(int dress) {
		this.dataManager.set(EntityPearl.DRESS_STYLE, dress);
	}
	public int getDressStyle() {
		return this.dataManager.get(EntityPearl.DRESS_STYLE);
	}
	public void setNaked(boolean naked) {
		this.dataManager.set(EntityPearl.NAKED, naked);
	}
	public boolean isNaked() {
		return this.dataManager.get(EntityPearl.NAKED);
	}
