...
import mod.kagic.entity.ai.EntityAIAttackTopaz;
...
import mod.kagic.entity.ai.EntityAITopazTarget;
...
public class EntityTopaz extends EntityGem implements INpc {
	...
	public EntityTopaz(World worldIn) {
		...
		this.dataManager.register(EntityTopaz.HOLDING, false);
	}
	...
	public boolean addHeldEntity(EntityLivingBase entity) {
		if (entity != null) {
			if (this.isFusion()) {
				...
				this.dataManager.set(EntityTopaz.HOLDING, true);
				this.heldEntities.add(entity);
				return true;
			}
			this.dataManager.set(EntityTopaz.HOLDING, false);
			return false;
		} else {
			this.dataManager.set(EntityTopaz.HOLDING, false);
	...
	public boolean isHolding() {
		return this.dataManager.get(EntityTopaz.HOLDING);
	}
