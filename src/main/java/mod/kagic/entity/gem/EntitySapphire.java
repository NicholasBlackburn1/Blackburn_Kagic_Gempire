...
import mod.kagic.entity.ai.EntityAIFutureVision;
import mod.kagic.entity.ai.EntityAIRetroVision;
...
public class EntitySapphire extends EntityGem implements INpc {
	...
	private static final List<Integer> SKIN_COLORS = new ArrayList<Integer>(Arrays.asList(0, // White
																																																																																																																																																																																					4,
																																																																																																																																																																																					4,
																																																																																																																																																																																					4,
																																																																																																																																																																																					4, // Yellow
	...
	public EntitySapphire(World worldIn) {
		super(worldIn);
		// Width must be 0.6, or she will get stuck trying
