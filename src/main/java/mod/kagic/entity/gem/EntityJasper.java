...
public class EntityJasper extends EntityQuartzSoldier implements IAnimals {
	...
	static {
		EntityJasper.MARK1S.put(0, 6);
		EntityJasper.MARK1S.put(1, 1);
		EntityJasper.MARK1S.put(2, 1);
		EntityJasper.MARK1S.put(3, 1);
		EntityJasper.MARK1S.put(4, 1);
		EntityJasper.MARK1S.put(5, 1);
		EntityJasper.MARK1S.put(6, 1);
		EntityJasper.MARK1S.put(7, 1);
		EntityJasper.MARK1S.put(8, 1);
	}
	
	private static final Map<Integer, Integer> MARK2S = new LinkedHashMap<Integer, Integer>();
	static {
		EntityJasper.MARK2S.put(0, 0);
		EntityJasper.MARK2S.put(1, 1);
		EntityJasper.MARK2S.put(2, 1);
		EntityJasper.MARK2S.put(3, 0);
		EntityJasper.MARK2S.put(4, 1);
		EntityJasper.MARK2S.put(5, 0);
		EntityJasper.MARK2S.put(6, 1);
		EntityJasper.MARK2S.put(7, 1);
		EntityJasper.MARK2S.put(8, 2);
	}
	...
	static {
		...
		normal.add(0xFDE7D9);
		normal.add(0xFFD69D);
		EntityJasper.HAIR_COLORS.put(0, normal);
		
		ArrayList<Integer> ocean = new ArrayList<Integer>();
		ocean.add(0xFaF9Fc);
		EntityJasper.HAIR_COLORS.put(1, ocean);
		
		ArrayList<Integer> biggs = new ArrayList<Integer>();
		biggs.add(0xFDF8EA);
		EntityJasper.HAIR_COLORS.put(2, biggs);

		ArrayList<Integer> green = new ArrayList<Integer>();
		green.add(0xDADCCC);
		EntityJasper.HAIR_COLORS.put(3, green);
		
		ArrayList<Integer> bruneau = new ArrayList<Integer>();
		bruneau.add(0xFACDA1);
		EntityJasper.HAIR_COLORS.put(4, bruneau);
		
		ArrayList<Integer> purple = new ArrayList<Integer>();
		purple.add(0xDECDD1);
		EntityJasper.HAIR_COLORS.put(5, purple);
		
		ArrayList<Integer> flame = new ArrayList<Integer>();
		flame.add(0xF0D2C6);
		EntityJasper.HAIR_COLORS.put(6, flame);
		
		ArrayList<Integer> picture = new ArrayList<Integer>();
		picture.add(0xEBDCCA);
		EntityJasper.HAIR_COLORS.put(7, picture);
		
		ArrayList<Integer> candyCane = new ArrayList<Integer>();
		candyCane.add(0xF9FFFE);
		EntityJasper.HAIR_COLORS.put(8, candyCane);
	}
	...
	static {
		...
		normal.add(0xD01729);
		normal.add(0xAC0522);
		EntityJasper.MARK_1_COLORS.put(0, normal);
		
		ArrayList<Integer> ocean = new ArrayList<Integer>();
		ocean.add(0x478397);
		ocean.add(0x173F55);
		EntityJasper.MARK_1_COLORS.put(1, ocean);
		
		ArrayList<Integer> biggs = new ArrayList<Integer>();
		biggs.add(0xD7AB85);
		biggs.add(0xC68976);
		EntityJasper.MARK_1_COLORS.put(2, biggs);

		ArrayList<Integer> green = new ArrayList<Integer>();
		green.add(0x6dab98);
		EntityJasper.MARK_1_COLORS.put(3, green);
		
		ArrayList<Integer> bruneau = new ArrayList<Integer>();
		bruneau.add(0xE59F54);
		EntityJasper.MARK_1_COLORS.put(4, bruneau);
		
		ArrayList<Integer> purple = new ArrayList<Integer>();
		purple.add(0x82838A);
		EntityJasper.MARK_1_COLORS.put(5, purple);
		
		ArrayList<Integer> flame = new ArrayList<Integer>();
		flame.add(0xE07769);
		EntityJasper.MARK_1_COLORS.put(6, flame);
		
		ArrayList<Integer> picture = new ArrayList<Integer>();
		picture.add(0xCA6C63);
		EntityJasper.MARK_1_COLORS.put(7, picture);
		
		ArrayList<Integer> candyCane = new ArrayList<Integer>();
		candyCane.add(0xB02E26);
		EntityJasper.MARK_1_COLORS.put(8, candyCane);
	}
	...
	static {
		ArrayList<Integer> normal = new ArrayList<Integer>();
		normal.add(0);
		EntityJasper.MARK_2_COLORS.put(0, normal);
		
		ArrayList<Integer> ocean = new ArrayList<Integer>();
		ocean.add(0xF47B95);
		ocean.add(0xFFC3D3);
		EntityJasper.MARK_2_COLORS.put(1, ocean);
		
		ArrayList<Integer> biggs = new ArrayList<Integer>();
		biggs.add(0xA2504E);
		EntityJasper.MARK_2_COLORS.put(2, biggs);

		ArrayList<Integer> green = new ArrayList<Integer>();
		green.add(0);
		EntityJasper.MARK_2_COLORS.put(3, green);
		
		ArrayList<Integer> bruneau = new ArrayList<Integer>();
		bruneau.add(0x8A511B);
		EntityJasper.MARK_2_COLORS.put(4, bruneau);

		ArrayList<Integer> purple = new ArrayList<Integer>();
		purple.add(0);
		EntityJasper.MARK_2_COLORS.put(5, purple);

		ArrayList<Integer> flame = new ArrayList<Integer>();
		flame.add(0xFFAD92);
		EntityJasper.MARK_2_COLORS.put(6, flame);

		ArrayList<Integer> picture = new ArrayList<Integer>();
		picture.add(0x91818B);
		EntityJasper.MARK_2_COLORS.put(7, picture);
		
		ArrayList<Integer> candyCane = new ArrayList<Integer>();
		candyCane.add(0x5E7C16);
		EntityJasper.MARK_2_COLORS.put(8, candyCane);
	}
	...
	public EntityJasper(World worldIn) {
		...
		this.dataManager.register(EntityJasper.CHARGED, false);
		this.dataManager.register(EntityJasper.MARK_1_COLOR, 0);
		this.dataManager.register(EntityJasper.MARK_1, 0);
		this.dataManager.register(EntityJasper.MARK_2_COLOR, 0);
		this.dataManager.register(EntityJasper.MARK_2, 0);
	}
	...
	public void writeEntityToNBT(NBTTagCompound compound) {
		compound.setBoolean("charged", this.dataManager.get(EntityJasper.CHARGED).booleanValue());
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		this.dataManager.set(EntityJasper.CHARGED, compound.getBoolean("charged"));
	...
	public boolean isCharged() {
		return this.dataManager.get(EntityJasper.CHARGED);
	}
	public void setCharged(boolean charged) {
		this.dataManager.set(EntityJasper.CHARGED, charged);
	}
	...
	public void onLivingUpdate() {
		...
		if (this.regenTicks > 200 && !(this.isDead || this.getHealth() <= 0.0F) && this.getHealth() < this.getMaxHealth()) {
			this.heal(1.0F);
			this.regenTicks = 0;
		}
	...
	public int getMark1Color() {
		return this.dataManager.get(EntityJasper.MARK_1_COLOR);
	}

	public void setMark1Color(int mark1Color) {
		this.dataManager.set(EntityJasper.MARK_1_COLOR, mark1Color);
	}

	public int getMark1() {
		return this.dataManager.get(EntityJasper.MARK_1);
	}

	public void setMark1(int mark1) {
		this.dataManager.set(EntityJasper.MARK_1, mark1);
	}

	public int getMark2Color() {
		return this.dataManager.get(EntityJasper.MARK_2_COLOR);
	}

	public void setMark2Color(int mark2Color) {
		this.dataManager.set(EntityJasper.MARK_2_COLOR, mark2Color);
	}

	public int getMark2() {
		return this.dataManager.get(EntityJasper.MARK_2);
	}

	public void setMark2(int mark2) {
		this.dataManager.set(EntityJasper.MARK_2, mark2);
	}
