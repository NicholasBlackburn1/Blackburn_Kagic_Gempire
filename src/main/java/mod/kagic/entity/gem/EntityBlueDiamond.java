...
public class EntityBlueDiamond extends EntityGem {
	...
	public EntityBlueDiamond(World worldIn) {
		...
		this.dataManager.register(EntityBlueDiamond.HOODED, true);
	}
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
		// KAGIC.instance.chatInfoMessage("Blue Diamond
		// onInitialSpawn called");
		this.setServitude(EntityGem.SERVE_BLUE_DIAMOND);
	...
	public boolean isHooded() {
		return this.dataManager.get(EntityBlueDiamond.HOODED);
	}
	public void setHooded(boolean hooded) {
		this.dataManager.set(EntityBlueDiamond.HOODED, hooded);
	}
