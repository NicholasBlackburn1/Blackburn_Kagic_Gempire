...
public class EntityFusionGem extends EntityGem {
	...
	public EntityFusionGem(World world) {
		...
		this.isSoldier = true;
		this.dataManager.register(EntityFusionGem.FUSION_TYPES, "");
		this.dataManager.register(EntityFusionGem.DEFECTIVE_COUNT, 0);
		this.dataManager.register(EntityFusionGem.PRIME_COUNT, 0);
		this.dataManager.register(EntityFusionGem.FUSION_COLOR, 0);
	...
	public NBTTagCompound writeToNBT(NBTTagCompound comp) {
		comp.setTag("gems", this.fusionGems);

		// comp.setInteger("typeSize",
		// this.gemTypes.size());
	...
	public String getFusionTypes() {
		return this.dataManager.get(EntityFusionGem.FUSION_TYPES);
	}

	public void setFusionTypes(String fusionTypes) {
		this.dataManager.set(EntityFusionGem.FUSION_TYPES, fusionTypes);
	}

	public int getDefectiveCount() {
		return this.dataManager.get(EntityFusionGem.DEFECTIVE_COUNT);
	}

	public void setDefectiveCount(int defectiveCount) {
		this.dataManager.set(EntityFusionGem.DEFECTIVE_COUNT, defectiveCount);
	}

	public int getPrimeCount() {
		return this.dataManager.get(EntityFusionGem.PRIME_COUNT);
	}

	public void setPrimeCount(int primeCount) {
		this.dataManager.set(EntityFusionGem.PRIME_COUNT, primeCount);
	}

	public int getFusionColor() {
		return this.dataManager.get(EntityFusionGem.FUSION_COLOR);
	}

	public void setFusionColor(int fusionColor) {
		this.dataManager.set(EntityFusionGem.FUSION_COLOR, fusionColor);
	}
