...
public class EntityAIShrimpAttackMelee extends EntityAIBase {
    World world;
    ...
    public EntityAIShrimpAttackMelee(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
    ...
    {
        return (double)(this.attacker.width * 1.0F * this.attacker.width * 1.0F + attackTarget.width);
    }
}