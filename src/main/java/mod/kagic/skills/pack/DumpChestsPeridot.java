...
public class DumpChestsPeridot extends Speak<EntityPeridot> {
	private BlockPos chestLocation = null;
	private boolean deposited = false;
	public DumpChestsPeridot() {
