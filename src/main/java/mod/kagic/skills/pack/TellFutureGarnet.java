...
public class TellFutureGarnet extends Speak<EntityGarnet> {
	public TellFutureGarnet() {
	...
	@Override
	public boolean proceed(EntityGarnet gem) {
		return true;
	}
	@Override
	public void init(EntityGarnet gem) {
		if (gem.isDefective()) {
